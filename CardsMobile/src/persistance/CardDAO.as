package persistance
{
	...
	public class CardDAO
	{
		...
		public function CardDAO(database:Database)
		{
		...
		public function getCards(owner:PlayerBase, cardsOutput:Array, handOutput:Array, groupsOutput:Vector.<CardGroup>):void
		{
			try {
			...
			{ 
				...
				groupsOutput[row.type_id].cards.addItem(card);
