package 
{
	...
	{
		[Embed(source="/../../media/theme/metalworks.png")]
		protected static const ATLAS_IMAGE:Class;

		[Embed(source="/../../media/theme/metalworks.xml",mimeType="application/octet-stream")]
		...
		protected function initialize():void
		{
			...
			this.setInitializerForClass(CardItemRenderer, cardItemRendererInitializer);
		}
		...
		// Card Item Renderer Functions
		protected function cardItemRendererInitializer(renderer:CardItemRenderer):void
		{
			const skinSelector:Scale9ImageStateValueSelector = new Scale9ImageStateValueSelector();
			skinSelector.setValueForState(this.buttonDownSkinTextures, Button.STATE_DOWN, false);
			skinSelector.imageProperties =
			...
			renderer.paddingTop = renderer.paddingBottom = 8 * this.scale;
			renderer.paddingLeft = renderer.paddingRight = 16 * this.scale;
			renderer.minWidth = renderer.minHeight = 60 * this.scale;
			renderer.minTouchWidth = renderer.minTouchHeight = 88 * this.scale;
		}
